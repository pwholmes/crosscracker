...
TEST_CLUES = [
    Clue(1, 'A', "One of a matched pair", 4, 0, 1, [("SOCK", 75), ("TWIN", 60)]),
    Clue(5, 'A', "Exclamation of surprise", 4, 1, 1, [("OHMY", 100)]),
    Clue(6, 'A', "Fruit used to make wine", 5, 2, 0, [("GRAPE", 100)]),
    Clue(7, 'A', "Land surrounded by water", 4, 3, 0, [("ISLE", 100)]),
    Clue(8, 'A', "Christmas song subject", 4, 4, 0, [("SNOW", 90), ("NOEL", 70)]),
    Clue(1, 'D', "Human trunk sans limbs and head", 5, 0, 1, [("TORSO", 100)]),
    Clue(2, 'D', "Giant marine mammal", 5, 0, 2, [("WHALE", 100)]),
    Clue(3, 'D', "Drive or urge onward", 5, 0, 3, [("IMPEL", 100)]),
    Clue(4, 'D', "Science Guy Bill", 3, 0, 4, [("NYE", 100)]),
    Clue(6, 'D', "Spirit in a martini", 3, 2, 0, [("GIN", 100)])
]
